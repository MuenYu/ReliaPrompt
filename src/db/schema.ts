...
export const prompts = sqliteTable(
    "prompts",
    {
        ...
        optimizerModelProvider: text("optimizer_model_provider"),
        optimizerModelId: text("optimizer_model_id"),
        optimizerMaxIterations: integer("optimizer_max_iterations").notNull().default(0),
        optimizerScoreThreshold: real("optimizer_score_threshold"),
...
export const testResults = sqliteTable(
    "test_results",
    {
        ...
        optimizationIteration: integer("optimization_iteration").notNull().default(0),
